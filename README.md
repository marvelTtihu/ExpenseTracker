...
* **Transaction List:** Display all transactions dynamically in a transaction log.
* **Persistent Storage:** Data is saved locally using `localStorage`, keeping your data safe even after a page refresh.
* **Delete Button:** Remove individual transactions with a single click.
